 ...
 */
class Product_Hero_Layout_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<div style="overflow: hidden; zoom: 1;">
			...
			<label style="width: 30.75%; float: left; margin-right: 3.8%; text-align: center; margin-bottom: 1.618em;">
				<img src="<?php echo plugins_url( '../assets/img/admin/left.png', __FILE__ ); ?>" alt="Option 1" style="display: block; width: 100%; margin-bottom: .618em" />
				<input type="radio" value="left" style="margin: 5px 0 0 0;" name="<?php echo esc_attr( $this->id ); ?>" <?php $this->link(); checked( $this->value(), 'left' ); ?> />
				<br/>
			</label>
			<label style="width: 30.75%; float: left; margin-right: 3.8%; text-align: center; margin-bottom: 1.618em;">
				<img src="<?php echo plugins_url( '../assets/img/admin/center.png', __FILE__ ); ?>" alt="Option 2" style="display: block; width: 100%; margin-bottom: .618em" />
			...
			<label style="width: 30.75%; float: left; text-align: center; margin-bottom: 1.618em;">
				<img src="<?php echo plugins_url( '../assets/img/admin/right.png', __FILE__ ); ?>" alt="Option 3" style="display: block; width: 100%; margin-bottom: .618em" />
