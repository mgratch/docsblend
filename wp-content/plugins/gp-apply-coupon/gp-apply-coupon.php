<?php
/**
 * Plugin Name:     Gravity Perks Apply Coupon
 * Plugin URI:      http://gravitywiz.com/creating-coupons-woocommerce-gravity-forms/
 * Description:     Create Coupons with Gravity Forms for Gravity Forms, WooCommerce, or Easy Digital Downloads
 * Author:          David Smith <david@gravitywiz.com>
 * Author URI:      gravitywiz.com
 * Text Domain:     gp-apply-coupon
 * Domain Path:     /languages
 * Version:         0.1.0
 *
 * @package         Gp_Apply_Coupon
 */
...
class GW_Create_Coupon {
	...
	public function create_coupon_gf( $coupon_code, $amount, $type ) {
