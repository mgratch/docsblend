...
function quoteupFormatPrice(price){
            decimal_separator = quote_data.decimal_separator;
            thousand_separator = quote_data.thousand_separator;
            decimals = quote_data.decimals;
            price_format = quote_data.price_format;
