...
class QuoteupGetData
{

    public static $responseData;

    public static function getDataFromDb($quoteup_plugin_data)
    {
        ...
        // $author_name = $quoteup_plugin_data['author_name'];
        $plugin_name = $quoteup_plugin_data[ 'plugin_name' ];
        // $plugin_short_name = $quoteup_plugin_data['plugin_short_name'];
        $plugin_slug = $quoteup_plugin_data[ 'plugin_slug' ];
        //$plugin_version = $quoteup_plugin_data['plugin_version'];
        $store_url   = $quoteup_plugin_data[ 'store_url' ];
        ...
        if (! $get_trans) {
            ...
            if ($license_key) {
                $api_params = array(
                    ...
                    'current_version'    => $quoteup_plugin_data[ 'plugin_version' ]
                );
