...
require_once(CT_THEME_DIR. '/theme/plugin/advanced-customizer/less/less_php/Version.php');
...
if (!class_exists('Less_Cache')) {
    ...
    class Less_Cache
    {
        ...
        public static function Cache(&$less_files, $parser_options = array())
        {
            ...
            $file = CT_THEME_DIR. '/theme/plugin/advanced-customizer/less/less-php/Less.php';
