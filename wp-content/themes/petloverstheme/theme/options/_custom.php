...
$theme_info .= '<p class="ct_theme-theme-data description theme-uri">' . __( '<strong>Support forum:</strong> ', 'ct_theme' ) . '<a href="' . CT_SUPPORT_URL . '" target="_blank">' . CT_SUPPORT_URL . '</a></p>';
...
$args['share_icons']['logo'] = array(
	...
	'img'   => CT_THEME_SETTINGS_MAIN_DIR_URI . '/assets/images/logo.png'
);
