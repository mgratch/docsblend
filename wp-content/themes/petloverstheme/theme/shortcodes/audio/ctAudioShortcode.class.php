 ...
 * Audio shortcode
 */
class ctAudioShortcode extends ctShortcode implements ctVisualComposerShortcodeInterface {
	...
	public function enqueueScripts() {
		wp_register_script( 'ct-jplayer',
			CT_THEME_ASSETS . '/js/jquery.jplayer.min.js',
			array( 'jquery' ),
			false,
			true );
	...
	public function getAttributes() {
		return array(
			'mp3'          => array(
				'default' => '',
				'type'    => 'input',
				'label'   => __( 'mp3 file link', 'ct_theme' ),
				'help'    => __( 'Direct link to .mp3 file', 'ct_theme' ),
				'example' => "http://www.jplayer.org/audio/mp3/Miaow-07-Bubble.mp3"
			),
			'ogg'          => array(
				'default' => '',
				'type'    => 'input',
				'label'   => __( 'ogg file link', 'ct_theme' ),
				'help'    => __( 'Direct link to .ogg, .oga file', 'ct_theme' ),
				'example' => "http://www.jplayer.org/audio/ogg/Miaow-07-Bubble.ogg"
			),
			'poster'       => array(
				'default' => '500',
				'type'    => 'input',
				'label'   => __( 'poster link', 'ct_theme' )
			),
			'posterheight' => array(
				'default' => '', 'type' => 'input',
				'label' => __( 'poster height', 'ct_theme' ),
				'help'  => __( 'Height of the poster in px', 'ct_theme' ) ),
			'width'        => array( 'default' => '500', 'type' => 'input', 'label' => __( 'Width', 'ct_theme' ) ),
			'class'        => array(
				'label'   => __( "Custom class", 'ct_theme' ),
				'default' => '',
				'type'    => 'input',
				'help'    => __( 'Adding custom class allows you to set diverse styles in css to the element. Type in name of class, which you defined in css. You can add as much classes as you like.',
					'ct_theme' )
			),
	...
	public function getVisualComposerInfo() {
		return new ctVisualComposerInfo( $this, array(
			'icon'        => 'fa-music',
			'description' => __( "Add audio player", 'ct_theme' )
		) );
	}
}
