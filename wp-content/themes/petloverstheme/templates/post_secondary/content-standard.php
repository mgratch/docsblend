...
<div class="col-xs-5">
    ...
    <div class="ct-articleBox-media">
        <?php get_template_part('templates/post_secondary/content-featured-image'); ?>
    </div>
...
<div class="col-xs-<?php echo $col;?>">
    ...
    <?php if (ct_get_context_option("posts_index_show_title", 1)): ?>
        <a href="<?php echo(esc_url(get_permalink($post->ID))) ?>"><h5 class="ct-fw-600"><?php echo esc_html(ct_get_blog_item_title()) ?></h5></a>
    <?php endif; ?>
    <!-- Meta -->
